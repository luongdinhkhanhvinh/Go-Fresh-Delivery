...
public class BaseURL {
    ...
    public static String BASE_URL = "https://thecodecafe.in/multi_vender/";
    public static String Loction = "https://thecodecafe.in/multi_vender/store/index.php/api/update_location";
    ...
    public static final String urlUpload = "https://thecodecafe.in/multi_vender/index.php/api/mark_delivered2";
